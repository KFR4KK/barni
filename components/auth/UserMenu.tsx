    ...
    <div ref={containerRef} className="relative">
      ...
      {open && (
        ...
        >
          ...
          {/*
            Points at a placeholder page for now — Discord-account-to-profile
            claiming is Phase 3. See app/profile/page.tsx for why this isn't
            "unfinished UI": it's a deliberate, static stub, not a half-built
            feature.
          */}
          <Link
            href="/profile"
