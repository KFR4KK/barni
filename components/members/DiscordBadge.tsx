...
// border-line, font-sans uppercase label) rather than introducing a new
// shape.
//
    ...
    <div className="flex flex-wrap items-center gap-3">
      {serverMember ? (
        <span
          className={
            compact
              ? "inline-flex items-center gap-1.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-2 py-0.5 font-sans text-[10px] uppercase tracking-wider text-emerald-400"
              : "inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-3.5 py-1.5 font-sans text-xs uppercase tracking-wider text-emerald-400"
          }
        >
        ...
        <span className="inline-flex items-center gap-2 rounded-full border border-line/60 bg-charcoal/40 px-3.5 py-1.5 font-sans text-xs uppercase tracking-wider text-ash">
