...
interface CommentsSectionProps {
   ...
   * appended. `/api/profile-comments` or `/api/project-comments`. */
      ...
      {viewer && (
        <form onSubmit={handleSubmitComment} className="mt-5 flex flex-col gap-2">
          ...
          <div className="flex items-center justify-between">
            {postError ? (
              <p className="font-mono text-xs text-brass">{POST_ERROR_MESSAGE}</p>
            ) : (
              <span />
            )}
            <button
              ...
              className="inline-flex items-center gap-2 rounded-md border border-line px-4 py-2 font-mono text-xs uppercase tracking-wider text-bone transition-colors duration-fast hover:border-brass hover:text-brass disabled:opacity-60"
            >
                ...
                footer={
                  viewer ? (
                    <button
                      ...
                      className="font-mono text-[11px] uppercase tracking-wider text-ash transition-colors duration-fast hover:text-brass"
                    >
                      Відповісти
                    </button>
                  ) : undefined
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="font-mono text-xs uppercase tracking-wider text-ash transition-colors duration-fast hover:text-bone"
                      >
                        Скасувати
                      </button>
                      <button
